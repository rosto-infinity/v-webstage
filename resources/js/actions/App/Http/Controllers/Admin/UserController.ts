...
* @see app/Http/Controllers/Admin/UserController.php:86
* @route '/dashboard'
*/
...
* @see app/Http/Controllers/Admin/UserController.php:37
...
* @see app/Http/Controllers/Admin/UserController.php:168
* @route '/gestions/users'
*/
...
* @see app/Http/Controllers/Admin/UserController.php:218
* @route '/gestions/users/{user}'
*/
