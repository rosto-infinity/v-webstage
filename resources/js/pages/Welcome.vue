    ...
    <div class="min-h-screen bg-gradient-to-b from-background/10 to-background">
        ...
        <section class="users-section bg-background/80 py-20 backdrop-blur-sm">
            <div class="mx-auto max-w-7xl px-6 lg:px-8">
                <h2 class="mb-8 text-3xl font-bold text-foreground">Liste des Utilisateurs</h2>
                <div class="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
                    ...
                    >
                        ...
                        <div class="mt-4">
                            <h4 class="text-lg font-semibold text-primary">Médias Sociaux</h4>
                            <div v-if="user.socialMedias && user.socialMedias.length > 0" class="space-y-2">
                                <div v-for="social in user.socialMedias" :key="social.id" class="social-media-item">
