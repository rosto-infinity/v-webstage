...
<template>
  ...
  <Transition name="fade">
    <div 
      v-if="isLoading"
      class="fixed inset-0 z-50 flex flex-col items-center justify-center gap-6 bg-background dark:bg-background-dark"
    >
      <div 
        ref="spinner"
        class="h-16 w-16 animate-spin rounded-full border-4 border-primary border-t-transparent dark:border-primary-dark"
      ></div>
      <p class="text-lg font-medium text-muted-foreground dark:text-muted-foreground-dark">
        Chargement en cours...
      </p>
    </div>
  </Transition>
  ...
  <!-- Contenu principal -->
  <div v-show="!isLoading" class="dark:from-background-dark/10 dark:to-background-dark min-h-screen bg-gradient-to-b from-background/10 to-background">
    <Head title="Welcome">
