...
import { useMotion } from '@vueuse/motion'; // Import de Motion
...
<template>
    ...
    <div class="dark:from-background-dark/10 dark:to-background-dark min-h-screen bg-gradient-to-b from-background/10 to-background">
        <!-- Header -->
        ...
        <section class="welcome-section relative overflow-hidden pb-7 text-center">
            <div class="relative z-10 mx-auto max-w-7xl px-6 py-0 sm:py-32 lg:px-8">
                ...
                <div class="mt-12 flex items-center justify-center gap-4 sm:flex-row">
                    ...
                    >
                        <sapn class="flex items-center gap-2">
                            Conditions de stage
                            <ShieldAlert />
                        </sapn>
                    </Link>
