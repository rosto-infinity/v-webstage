...
const diplomeOptions = computed(() => 
    Object.entries(diplomes).map(([value, label]) => ({ value, label }))
);
    ...
    <AppLayout :breadcrumbs="breadcrumbItems">
        ...
        <SettingsLayout>
            <div class="flex max-w-4xl flex-col space-y-6">
                <HeadingSmall 
                    title="Mes stages" 
                    description="Gérez vos rapports de stage et projets académiques" 
                />
                    ...
                    <div class="space-y-4">
                        <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                            ...
                            <div class="space-y-2">
                                ...
                                <Select v-model="selectedDiplome">
                                    ...
                                    <SelectContent>
                                        <SelectItem 
                                            v-for="option in diplomeOptions" 
                                            :key="option.value"
                                            :value="option.value"
                                        >
                                            {{ option.label }}
                        ...
                        <div class="space-y-2">
                            ...
                            <Input
                                ...
                                name="url_github"
                                type="url"
                                placeholder="https://github.com/votre-repo/projet"
                            />
                        ...
                        <div class="space-y-2">
                            ...
                            <p class="text-xs text-muted-foreground">
                                Formats acceptés : JPEG, PNG, GIF, WebP (max 2MB par image)
                            </p>
                    ...
                    >
                                ...
                                <div class="flex items-start justify-between">
                                    <div class="flex-1">
                                        ...
                                        <p class="text-sm text-muted-foreground">
                                            {{ stage.diplome_label }} • {{ stage.created_at }}
                                        </p>
                                        <a 
                        ...
                        >
                            ...
                            <div class="space-y-2">
                                ...
                                <Input
                                    :id="`url_github-${stage.id}`"
                                    name="url_github"
                                    type="url"
                                    :default-value="stage.url_github"
                                />
                                <p v-if="errors.url_github" class="text-xs text-destructive">
                                    {{ errors.url_github }}
                                </p>
                            ...
                            <div class="space-y-2">
                                <Label :for="`images-${stage.id}`">
                                    Nouvelles images (optionnel - 3 à 5 images)
                                </Label>
                                <Input
                                    :id="`images-${stage.id}`"
                                    name="images"
