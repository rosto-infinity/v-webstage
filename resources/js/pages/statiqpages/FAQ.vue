...
import { ChevronDown, Briefcase, HelpCircle } from 'lucide-vue-next'
...
<template>
  <div class="min-h-screen bg-white text-slate-900 dark:bg-slate-950 dark:text-slate-100 flex flex-col">
    <Head>
      ...
      <meta name="description" content="Retrouvez toutes les réponses aux questions fréquentes sur les stages et les cours : préparation, droits, obligations, gestion du temps, valorisation et plus." />
      <meta property="og:title" content="FAQ Stage - Questions Fréquentes | www.stage.devinsto.com" />
      <meta property="og:description" content="Toutes les réponses aux questions fréquentes sur les stages et les cours : préparation, droits, obligations, gestion du temps, valorisation." />
    ...
    <main class="flex-1">
      <div class="bg-gradient-to-r from-violet-100 to-violet-200 dark:from-violet-900/20 dark:to-slate-800/20 border-b border-violet-200 dark:border-violet-500/20">
        <div class="max-w-3xl mx-auto px-4 py-10 sm:px-6 lg:px-8 text-center">
          <div class="flex justify-center mb-4 animate-fade-in-down">
            <div class="w-16 h-16 bg-violet-700 dark:bg-violet-500 rounded-xl flex items-center justify-center shadow-lg shadow-violet-200/40 dark:shadow-violet-900/40">
              <Briefcase class="w-8 h-8 text-slate-100 dark:text-slate-900" />
            </div>
          </div>
          <h1 class="text-3xl sm:text-4xl font-bold mb-2">FAQ Stage - Questions Fréquemment Posées</h1>
          <p class="text-xl text-violet-700 dark:text-violet-400 font-semibold mb-2">www.stage.devinsto.com</p>
          <p class="text-slate-700 dark:text-slate-400 max-w-2xl mx-auto leading-relaxed">
            ...
            Si vous avez d’autres interrogations, <a href="#" class="underline text-violet-700 dark:text-violet-400 hover:text-violet-900 dark:hover:text-violet-300 transition">contactez-nous</a> !
          </p>
      ...
      <div class="max-w-7xl mx-auto px-4 py-10 sm:px-6 lg:px-8">
        <div class="space-y-4" itemscope itemtype="https://schema.org/FAQPage">
          <TransitionGroup name="faq-fade" tag="div">
            ...
            >
              <button
                class="w-full flex items-center justify-between px-6 py-5 text-left focus:outline-none group border-b-violet-100 dark:border-b-violet-900 bg-slate-100 dark:bg-slate-800/40 border-b-2"
                @click="toggle(idx)"
              ...
              >
                <span class="flex items-center gap-3 text-lg font-semibold text-slate-900 dark:text-slate-100 transition-colors">
                  <span class="w-7 h-7 rounded-full bg-violet-100 dark:bg-violet-900 flex items-center justify-center mr-2">
                    <HelpCircle class="w-5 h-5 text-violet-700 dark:text-violet-400" />
                  </span>
                  <span itemprop="name">{{ idx + 1 }}. {{ faq.question }}</span>
                </span>
                <span class="transition-transform duration-300"
                  :class="openIndex === idx ? 'rotate-180 text-violet-700 dark:text-violet-400' : 'text-slate-400 dark:text-slate-500'">
