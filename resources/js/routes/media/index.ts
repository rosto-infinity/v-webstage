 ...
 */
export const update = (
    args: { socialMedia: number | { id: number } } | [socialMedia: number | { id: number }] | number | { id: number },
...
update.url = (
    ...
    const parsedArgs = {
        socialMedia: typeof args.socialMedia === 'object' ? args.socialMedia.id : args.socialMedia,
    };

    return update.definition.url.replace('{socialMedia}', parsedArgs.socialMedia.toString()).replace(/\/+$/, '') + queryParams(options);
};
...
destroy.url = (
    ...
    return destroy.definition.url.replace('{socialMedia}', parsedArgs.socialMedia.toString()).replace(/\/+$/, '') + queryParams(options);
};
